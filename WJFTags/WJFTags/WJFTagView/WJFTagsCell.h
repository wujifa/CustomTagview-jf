...
#import "WJFTagCollectionViewFlowLayout.h"

@class WJFTagAttribute;

@interface WJFTagsCell : UITableViewCell
...
@property (nonatomic,strong) WJFTagAttribute *tagAttribute;//按钮样式对象
