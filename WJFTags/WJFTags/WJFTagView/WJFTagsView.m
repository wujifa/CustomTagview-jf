...
@interface WJFTagsView () <UICollectionViewDelegate, UICollectionViewDataSource>
...
+ (CGFloat)getHeightWithTags:(NSArray *)tags layout:(WJFTagCollectionViewFlowLayout *)layout tagAttribute:(WJFTagAttribute *)tagAttribute width:(CGFloat)width
{
