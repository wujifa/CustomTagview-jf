...
#import "WJFTagAttribute.h"

@interface WJFTagsCell () <UICollectionViewDelegate, UICollectionViewDataSource>

@property (nonatomic,strong) UICollectionView *collectionView;

@end

@implementation WJFTagsCell
...
{
    //初始化样式
    _tagAttribute = [WJFTagAttribute new];
    
    _layout = [[WJFTagCollectionViewFlowLayout alloc] init];
...
{
    WJFTagCollectionViewFlowLayout *layout = (WJFTagCollectionViewFlowLayout *)collectionView.collectionViewLayout;
...
{
    WJFTagCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
...
{
    WJFTagCollectionViewCell *cell = (WJFTagCollectionViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[WJFTagCollectionViewCell class] forCellWithReuseIdentifier:reuseIdentifier];
    }
...
+ (CGFloat)getCellHeightWithTags:(NSArray *)tags layout:(WJFTagCollectionViewFlowLayout *)layout tagAttribute:(WJFTagAttribute *)tagAttribute width:(CGFloat)width
{
    CGFloat contentHeight = 0;
    
    if (!layout) {
        layout = [[WJFTagCollectionViewFlowLayout alloc] init];
    }
    
    if (tagAttribute.titleSize <= 0) {
        tagAttribute = [[WJFTagAttribute alloc] init];
    }
